...
doctors_ratings = doctors[doctors.experience>=15]
doctors_ratings['rating'].plot.box()
...
print("Test set score: {:.3f}".format(knn_model_1.score(X_test,y_test)))
...
prediction = knn_model_1.predict(X_new)
